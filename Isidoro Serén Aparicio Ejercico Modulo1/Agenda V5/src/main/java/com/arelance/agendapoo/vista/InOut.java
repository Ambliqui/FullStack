...
public class InOut {
    ...
    /**
     * *************************************************************************
     * Sobrecargamos el metodo getData por 2 motivos: Solo vamos a recoger datos
     * numericos en los Menus (No hace falta imprimir mesaje puesto que lleva su
     * propio msg en forma de menu). Ademas en este caso hay que validarlo.
     *
     * Solo tenemos que lanzar un mensaje al usuario cuando vayamos a pedir un
     * tipo String en nuestra aplicación
     */
    ...
    public void printContact(String[][] contacto, int index) {
        //Vamos a encadenar todo el texto
