...
public class Schedule {
    ...
    public String[] modifyContact(String[] contacto) {
        //Comprobamos que el elemento existe
        System.out.println(Arrays.deepEquals(contactos, contacto)); //Pedimos los nuevos datos de contacto
        contactos[1] = ScheduleDao.createContact();
