    ...
    public static void printMainMenu(Schedule agenda) {
        ...
        while (true) {
            ...
            switch (option) {
                 ...
                 * otra forma de implementar los condicionales. Los he puesto en
                 * los case y no en los metodos porque los veo mas localizables
                 * en caso de tener que realizar cambios de cualquier tipo.
                 *
